...
def dataPrepForString(str_,tokenizer,MAX_LENGTH):
    articlebodytok = [str_.split()]
    artbodytok = tokenizer.texts_to_sequences(articlebodytok)
    articlepadded = getPaddedData(artbodytok,MAX_LENGTH)
    return articlepadded
